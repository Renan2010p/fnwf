...
public:
    ...
    static void text(Engine& eng,
                     ...
                     bool center = false,
                     std::int32_t font_idx = -1);

    static void text_rotated(Engine& eng,
                             const std::string& text,
                             std::int32_t x,
                             std::int32_t y,
                             double angle,
    ...
    static void static_noise(Engine& eng,
                             std::int32_t x,
                             std::int32_t y,
                             std::uint32_t w,
                             std::uint32_t h,
                             float intensity = 0.3f);
    static void scanlines(Engine& eng,
                          std::int32_t x,
                          std::int32_t y,
                          std::uint32_t w,
                          std::uint32_t h,
                          std::uint8_t alpha = 30);
    static void button_box(Engine& eng,
                           std::int32_t x,
                           std::int32_t y,
                           std::uint32_t w,
                           std::uint32_t h,
                           ...
                           std::uint8_t b_off = 65);
    static void animatronic_sprite(Engine& eng,
                                   const std::string& name,
                                   std::int32_t x,
                                   std::int32_t y,
                                   std::uint32_t w,
                                   std::uint32_t h);
    static void trapezoid(Engine& eng,
                          std::uint8_t r,
                          std::uint8_t g,
                          std::uint8_t b,
                          std::int32_t p1x,
    ...
    static void star(Engine& eng,
                     ...
                     std::uint8_t g = 255,
                     std::uint8_t b = 100);
    static void animatronic_face(Engine& eng,
                                 const std::string& name,
                                 std::int32_t x,
                                 std::int32_t y,
                                 std::uint32_t w,
                                 std::uint32_t h);
    static void rounded_texture(Engine& eng,
                                ...
                                std::uint8_t bg_b = 9,
                                std::uint8_t alpha = 255);
    static void apply_camera_effect(Engine& eng,
                                    float noise_intensity = 0.02f,
                                    std::uint8_t scanline_alpha = 30,
                                    std::uint32_t scanline_spacing = 4);
    static void vignette(Engine& eng,
                         float intensity = 0.3f,
                         std::uint8_t r = 0,
                         std::uint8_t g = 0,
                         std::uint8_t b = 0);
    ...
    static void vhs_osd(Engine& eng,
                        const std::string& text,
                        std::int32_t x,
                        std::int32_t y,
                        std::uint8_t r = 210,
